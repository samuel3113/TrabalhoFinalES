...
public class SistemaDAO {
	public boolean registraVenda(ModelProdutos model){
		...
		ResultSet rs = null;
		if(model.getOperacao().isBlank() || model.getQtd()==0 ||
			...
			try {
				...
				stmt.setString(2, model.getVendedor());
				stmt.setDouble(3, model.getTaxa());
				stmt.setDouble(4, model.getValorTotal());
				stmt.setDouble(5, model.getSubTotal());
				stmt.setInt(6, model.getQtd());
				stmt.setInt(7, model.getMesa());
